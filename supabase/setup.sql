...
-- Everything below moves data off feed_id and then drops it. On a database
-- that already made the move there is no feed_id, so the whole block is
-- skipped: this is what lets the one-paste setup file be run again safely.
do $$
begin
  if not exists (
    select 1 from information_schema.columns
     where table_schema = 'public' and table_name = 'crm_connections' and column_name = 'feed_id'
  ) then
    return;
  end if;
...
-- ============================================================
-- 20260911090000_delivery_failures.sql
-- ============================================================
...
-- ============================================================
-- 20260916100000_workspace_last_seen.sql
-- ============================================================
