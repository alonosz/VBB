...
/**
 * A small, seeded generator, so a permutation test gives the same answer for
 * the same file every time. A figure that changed on refresh would read as a
 * slot machine rather than a measurement.
 */
